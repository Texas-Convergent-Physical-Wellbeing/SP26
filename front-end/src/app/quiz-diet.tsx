  ...
  const onFinish = async () => {
    ...
    try {
      await api.upsertProfile({
        sex: quizStore.sex,
        age: quizStore.age,
        weight_kg: quizStore.weight_kg,
        height_cm: quizStore.height_cm,
        activity_level: quizStore.activity_level,
        health_conditions: quizStore.health_conditions,
        allergens: [],
        cuisines: quizStore.cuisines,
        diet_preferences: selected,
